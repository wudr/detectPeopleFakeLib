...
extern "C" TFL_DLL TFL_RESULT GetPeopleDataWrapper(DetectPeole* pInstance, TFL_PointXYZ*** outputGetPeopleData, TFL_PointXYZ** outputheadPoints, float** outputheights, size_t* humanNum);